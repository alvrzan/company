    ...
    >
        <div class="flex items-center w-full md:w-auto justify-between">
            <div class="flex items-center">
                ...
                <h1 class="text-white text-xl drop-shadow-lg">
        ...
        >
            <ul
                class="flex flex-col mt-4 md:mt-0 mb-4 md:mb-0 md:flex-row items-center space-y-2 md:space-y-0 md:space-x-8 text-white/60 font-semibold text-lg drop-shadow-lg"
            >
                <li class="min-w-28 md:min-h-0 text-center">
                    <a href="manual">User Manual</a>
                </li>
                <li class="min-w-28 text-center md:min-h-0">
                    <a href="#">Products</a>
                </li>
                <li class="min-w-28 text-center md:min-h-0">
                    <a href="#">About Us</a>
